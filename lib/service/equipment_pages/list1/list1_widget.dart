...
import '/service/common_components/edit_row/edit_row_widget.dart';
import '/service/common_components/mass_edit_date_dialog/mass_edit_date_dialog_widget.dart';
                          ...
                          .mapIndexed((dataTableIndex, dataTableEquipmentRow) =>
                              [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      dataTableEquipmentRow.nextDue3
                                          ?.toString(),
                                      'hydro',
                                    ),
                                    style:
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    dataTableEquipmentRow.loanerSn,
                                    'loaner',
                                  ),
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                ...
                                EditRowWidget(
                                  key: Key(
                                      'Keyqtz_${dataTableIndex}_of_${dataTableEquipmentRowList.length}'),
                                  equipmentId: dataTableEquipmentRow.id,
                                ),
