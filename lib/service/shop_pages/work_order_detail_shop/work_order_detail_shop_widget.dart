...
import '/service/common_components/find_extinguisher_shop/find_extinguisher_shop_widget.dart';
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Row(
                ...
                children: [
                  Text(
                    '${workOrderDetailShopCustomersRow?.name == null || workOrderDetailShopCustomersRow?.name == '' ? '' : workOrderDetailShopCustomersRow?.name}- Work Order ${widget.workOrder?.toString()}',
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed('workOrderListShop');
                    },
                    child: Icon(
                      Icons.close,
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            controller: _model
                                              ...
                                              _model.dropDownValue1 ??=
                                                  infoWorkOrdersRow?.source,
                                            ),
                                            options: const ['Shop', 'Field'],
                                            onChanged: (val) async {
                                              setState(() =>
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                          .wonotesController ??=
                                                      TextEditingController(
                                                    text: infoWorkOrdersRow
                                                        ?.notes,
                                                  ),
                                                  focusNode:
                                                      _model.wonotesFocusNode,
                                                  onFieldSubmitted: (_) async {
                                                    await WorkOrdersTable()
                                                        .update(
                                                      data: {
                                                ...
                                                child: TextFormField(
                                                  controller:
                                                      _model.textController3 ??=
                                                          TextEditingController(
                                                    text:
                                                        workOrderDetailShopCustomersRow
                                                            ?.notes,
                                                  ),
                                                  focusNode: _model
                                                      .textFieldFocusNode2,
                                                                ...
                                                                return FutureBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    List<EqptWoLisRow>
                                                                        ...
                                                                        snapshot
                                                                            .data!;
                                                                    final containerEqptWoLisRow = containerEqptWoLisRowList
                                                                            .isNotEmpty
                                                                        ? containerEqptWoLisRowList
                                                                            .first
                                                                        : null;
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                          Visibility(
                                                                        visible: ((!_model.showSwitch1Value! && (containerEqptWoLisRow?.status == 'To Shop')) ||
                                                                                (_model.showSwitch1Value! && (containerEqptWoLisRow?.status == 'Completed'))) &&
                                                                            ((_model.visibleData == null || _model.visibleData == '') ||
