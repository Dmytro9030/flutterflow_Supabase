...
import '/service/open_wo_from_lookup/open_wo_from_lookup_widget.dart';
import '/flutter_flow/custom_functions.dart' as functions;
import 'package:flutter/material.dart';
import 'lookup_ext_model.dart';
export 'lookup_ext_model.dart';

class LookupExtWidget extends StatefulWidget {
  const LookupExtWidget({super.key});

  @override
  State<LookupExtWidget> createState() => _LookupExtWidgetState();
}

class _LookupExtWidgetState extends State<LookupExtWidget> {
  late LookupExtModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LookupExtModel());
    ...
    _model.serialFocusNode!.addListener(
      () async {
        setState(() {
          _model.serial = _model.serialController.text;
        });
      },
    );
                      ...
                      child: Column(
                        ...
                        children: List.generate(columnEquipmentRowList.length,
                          ...
                          return Container(
                            ...
                            child: Visibility(
                              visible: functions.subContainingFunc(
                              ...
                              child: FutureBuilder<List<CustomersRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CustomersRow> columnCustomersRowList =
                                      snapshot.data!;
                                  final columnCustomersRow =
                                      columnCustomersRowList.isNotEmpty
                                                            ...
                                                            builder: (context) {
                                                              return Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  height: 200.0,
                                                                  child:
                                                                      OpenWoFromLookupWidget(
                                                                    wo: columnEqptWoLisRow
                                                                        .wo!,
                                                                  ),
                                                                ),
                                                              );
