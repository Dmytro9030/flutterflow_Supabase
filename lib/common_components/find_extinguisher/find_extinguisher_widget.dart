...
import 'find_extinguisher_model.dart';
export 'find_extinguisher_model.dart';

class FindExtinguisherWidget extends StatefulWidget {
  const FindExtinguisherWidget({
    super.key,
  ...
  @override
  State<FindExtinguisherWidget> createState() => _FindExtinguisherWidgetState();
}

class _FindExtinguisherWidgetState extends State<FindExtinguisherWidget> {
  late FindExtinguisherModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FindExtinguisherModel());
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: List.generate(columnEquipmentRowList.length,
                      ...
                      return Visibility(
                        visible: (_model.visibleString == null ||
                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<List<CustomersRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CustomersRow> rowCustomersRowList =
                                  snapshot.data!;
                              final rowCustomersRow =
                                  rowCustomersRowList.isNotEmpty
                                      ? rowCustomersRowList.first
                                      : null;
                              return Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
