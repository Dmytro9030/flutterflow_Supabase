                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      _model.newEqpt = await EquipmentTable().insert({
                        ...
                        'serial': _model.textController6.text,
                        'inspectionDate2':
                        ...
                        'notes': _model.textController7.text,
                        'details':
                            '${_model.textController1.text} ${_model.textController2.text} ${_model.textController3.text}A ${_model.textController4.text} BC ${_model.dropDownValue2}',
                      });
