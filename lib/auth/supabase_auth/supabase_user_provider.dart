...
class Serviceapp2SupabaseUser extends BaseAuthUser {
  Serviceapp2SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> serviceapp2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Serviceapp2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
