...
import 'invoice_detail_copy_model.dart';
export 'invoice_detail_copy_model.dart';

class InvoiceDetailCopyWidget extends StatefulWidget {
  const InvoiceDetailCopyWidget({
    super.key,
  ...
  @override
  State<InvoiceDetailCopyWidget> createState() =>
      _InvoiceDetailCopyWidgetState();
}

class _InvoiceDetailCopyWidgetState extends State<InvoiceDetailCopyWidget> {
  late InvoiceDetailCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvoiceDetailCopyModel());
    ...
    _model.textFieldFocusNode6!.addListener(
      () async {
        await WorkOrdersTable().update(
          data: {
            'invoice_link': _model.textController6.text,
          },
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<WorkOrdersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WorkOrdersRow> invoiceDetailCopyWorkOrdersRowList = snapshot.data!;
        final invoiceDetailCopyWorkOrdersRow =
            invoiceDetailCopyWorkOrdersRowList.isNotEmpty
                ? invoiceDetailCopyWorkOrdersRowList.first
                : null;
            ...
            appBar: AppBar(
              ...
              title: Text(
                valueOrDefault<String>(
                  invoiceDetailCopyWorkOrdersRow?.id.toString(),
                  'num',
                ),
              ...
              child: Padding(
                ...
                child: FutureBuilder<List<CustomersRow>>(
                  future: CustomersTable().querySingleRow(
                    queryFn: (q) => q.eq(
                      'id',
                      invoiceDetailCopyWorkOrdersRow?.customer,
                    ),
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.textController6 ??=
                                                      TextEditingController(
                                                text: valueOrDefault<String>(
                                                  invoiceDetailCopyWorkOrdersRow
                                                      ?.invoiceLink,
                                                  'link',
                                                ),
                                              ),
                                                        ...
                                                        return Card(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              DropDownWidget(
                                                                key: Key(
                                                                    'Keyrif_${wrapIndex}_of_${wrapCommentsRowList.length}'),
                                                                status:
                                                                    valueOrDefault<
                                                                        String>(
                                                                  wrapCommentsRow
